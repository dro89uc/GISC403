...
const map = L.map('map').setView([-41.272, 173.299], 9);
...
const marker1 = L.marker([-31.008, 174.786]).addTo(map)
...
const polygon = L.polygon([
		...
		color: 'yellow',
		fillColor: '#ffff66',
	}).addTo(map).bindPopup('Dunedin Airport - DUD - formerly international');
